...
import { createMessageSend, MessageSendParams, Sender} from '@astradefi/transactions'
...
const url = 'https://api.astranaut.io'

const urlBalance = 'https://api.astranaut.io/cosmos/bank/v1beta1/balances/'
...
async function signAndBroadcastTx(wallet: Wallet, sender: Sender, url: string) {
    ...
    const params: MessageSendParams = {
        ...
        destinationAddress: 'astra14rajuselkxsvqtqv20lamd08t8zxg8qdz5sv9j',
