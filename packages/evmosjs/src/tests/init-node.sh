...
KEY="mykey"
SENDER="evmos16famsnv0hqks7z9h60cn052y4t46jhsk20792m"
...
evmosd start "$TRACE" --log_level $LOGLEVEL --minimum-gas-prices=0.0001aevmos --json-rpc.api eth,txpool,personal,net,debug,web3 --api.enable
