...
import { MsgConvertCoin } from '../../src/types/evmos/erc20/tx'
import { MsgRegisterRevenue } from '../../src/types/evmos/revenue/tx'
...
export const genTestMsgRegisterRevenue = (): TestMessage => [
