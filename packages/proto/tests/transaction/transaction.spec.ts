  ...
  it('createSigDoc test', () => {
    ...
    expect(res.toObject()).toStrictEqual({
      ...
      auth_info_bytes: new Uint8Array([
        10, 89, 10, 81, 10, 40, 47, 101, 116, 104, 101, 114, 109, 105, 110, 116,
        ...
        20, 10, 253, 14, 105, 23, 18, 4, 10, 2, 8, 1, 18, 19, 10, 13, 10, 7, 97,
        112, 104, 111, 116, 111, 110, 18, 2, 50, 48, 16, 160, 156, 1,
      ]),
      chain_id: chainId,
