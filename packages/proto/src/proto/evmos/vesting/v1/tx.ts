...
import * as dependency_1 from "./../../../cosmos/vesting/v1beta1/vesting";
...
export namespace evmos.vesting.v1 {
    export class MsgCreateClawbackVestingAccount extends pb_1.Message {
        ...
        constructor(data?: any[] | {
            ...
            lockup_periods?: dependency_1.cosmos.vesting.v1beta1.Period[];
            vesting_periods?: dependency_1.cosmos.vesting.v1beta1.Period[];
            merge?: boolean;
        }) {
            super();
        ...
        get start_time() {
            return pb_1.Message.getWrapperField(this, dependency_4.google.protobuf.Timestamp, 3) as dependency_4.google.protobuf.Timestamp;
        }
        ...
        get lockup_periods() {
            return pb_1.Message.getRepeatedWrapperField(this, dependency_1.cosmos.vesting.v1beta1.Period, 4) as dependency_1.cosmos.vesting.v1beta1.Period[];
        }
        set lockup_periods(value: dependency_1.cosmos.vesting.v1beta1.Period[]) {
            pb_1.Message.setRepeatedWrapperField(this, 4, value);
        }
        get vesting_periods() {
            return pb_1.Message.getRepeatedWrapperField(this, dependency_1.cosmos.vesting.v1beta1.Period, 5) as dependency_1.cosmos.vesting.v1beta1.Period[];
        }
        set vesting_periods(value: dependency_1.cosmos.vesting.v1beta1.Period[]) {
        ...
        static fromObject(data: {
            ...
            lockup_periods?: ReturnType<typeof dependency_1.cosmos.vesting.v1beta1.Period.prototype.toObject>[];
            vesting_periods?: ReturnType<typeof dependency_1.cosmos.vesting.v1beta1.Period.prototype.toObject>[];
            merge?: boolean;
            ...
            if (data.lockup_periods != null) {
                message.lockup_periods = data.lockup_periods.map(item => dependency_1.cosmos.vesting.v1beta1.Period.fromObject(item));
            }
            if (data.vesting_periods != null) {
                message.vesting_periods = data.vesting_periods.map(item => dependency_1.cosmos.vesting.v1beta1.Period.fromObject(item));
            }
            if (data.merge != null) {
        ...
        toObject() {
            ...
            if (this.lockup_periods != null) {
                data.lockup_periods = this.lockup_periods.map((item: dependency_1.cosmos.vesting.v1beta1.Period) => item.toObject());
            }
            if (this.vesting_periods != null) {
                data.vesting_periods = this.vesting_periods.map((item: dependency_1.cosmos.vesting.v1beta1.Period) => item.toObject());
            }
            if (this.merge != null) {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.lockup_periods.length)
                writer.writeRepeatedMessage(4, this.lockup_periods, (item: dependency_1.cosmos.vesting.v1beta1.Period) => item.serialize(writer));
            if (this.vesting_periods.length)
                writer.writeRepeatedMessage(5, this.vesting_periods, (item: dependency_1.cosmos.vesting.v1beta1.Period) => item.serialize(writer));
            if (this.merge != false)
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        reader.readMessage(message.lockup_periods, () => pb_1.Message.addToRepeatedWrapperField(message, 4, dependency_1.cosmos.vesting.v1beta1.Period.deserialize(reader), dependency_1.cosmos.vesting.v1beta1.Period));
                        break;
                    case 5:
                        reader.readMessage(message.vesting_periods, () => pb_1.Message.addToRepeatedWrapperField(message, 5, dependency_1.cosmos.vesting.v1beta1.Period.deserialize(reader), dependency_1.cosmos.vesting.v1beta1.Period));
                        break;
                    case 6:
    ...
    export class MsgUpdateVestingFunder extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            funder_address?: string;
            ...
            if (!Array.isArray(data) && typeof data == "object") {
                ...
                if ("new_funder_address" in data && data.new_funder_address != undefined) {
                    this.new_funder_address = data.new_funder_address;
                }
                if ("vesting_address" in data && data.vesting_address != undefined) {
                    this.vesting_address = data.vesting_address;
                }
            }
        }
        get funder_address() {
        ...
        get new_funder_address() {
            return pb_1.Message.getFieldWithDefault(this, 2, "") as string;
        }
        set new_funder_address(value: string) {
            pb_1.Message.setField(this, 2, value);
        }
        get vesting_address() {
            return pb_1.Message.getFieldWithDefault(this, 3, "") as string;
        }
        set vesting_address(value: string) {
            pb_1.Message.setField(this, 3, value);
        }
        static fromObject(data: {
            funder_address?: string;
            ...
            const message = new MsgUpdateVestingFunder({});
            if (data.funder_address != null) {
                message.funder_address = data.funder_address;
            }
            if (data.new_funder_address != null) {
                message.new_funder_address = data.new_funder_address;
            }
            if (data.vesting_address != null) {
                message.vesting_address = data.vesting_address;
            }
            return message;
        }
        toObject() {
            ...
            if (this.new_funder_address != null) {
                data.new_funder_address = this.new_funder_address;
            }
            if (this.vesting_address != null) {
                data.vesting_address = this.vesting_address;
            }
            return data;
        }
        serialize(): Uint8Array;
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.funder_address.length)
                writer.writeString(1, this.funder_address);
            if (this.new_funder_address.length)
                writer.writeString(2, this.new_funder_address);
            if (this.vesting_address.length)
                writer.writeString(3, this.vesting_address);
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): MsgUpdateVestingFunder {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new MsgUpdateVestingFunder();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
                    case 1:
                        ...
                        break;
                    case 2:
                        message.new_funder_address = reader.readString();
                        break;
                    case 3:
                        message.vesting_address = reader.readString();
                        break;
                    default: reader.skipField();
                }
            }
        ...
        static deserializeBinary(bytes: Uint8Array): MsgUpdateVestingFunder {
            return MsgUpdateVestingFunder.deserialize(bytes);
        }
    }
    export class MsgUpdateVestingFunderResponse extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {}) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
        ...
        static fromObject(data: {}): MsgUpdateVestingFunderResponse {
            const message = new MsgUpdateVestingFunderResponse({});
            return message;
        }
        toObject() {
            const data: {} = {};
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): MsgUpdateVestingFunderResponse {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new MsgUpdateVestingFunderResponse();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
        ...
        static deserializeBinary(bytes: Uint8Array): MsgUpdateVestingFunderResponse {
