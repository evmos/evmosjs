...
export namespace evmos.claims.v1 {
    export class MsgUpdateParams extends pb_1.Message {
        ...
        constructor(data?: any[] | {
            authority?: string;
            params?: dependency_3.evmos.claims.v1.Params;
        }) {
            super();
        ...
        get params() {
            return pb_1.Message.getWrapperField(this, dependency_3.evmos.claims.v1.Params, 2) as dependency_3.evmos.claims.v1.Params;
        }
        set params(value: dependency_3.evmos.claims.v1.Params) {
        ...
        static fromObject(data: {
            authority?: string;
            params?: ReturnType<typeof dependency_3.evmos.claims.v1.Params.prototype.toObject>;
        }): MsgUpdateParams {
            ...
            if (data.params != null) {
                message.params = dependency_3.evmos.claims.v1.Params.fromObject(data.params);
            }
            return message;
        }
        toObject() {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        ...
                        break;
                    case 2:
                        reader.readMessage(message.params, () => message.params = dependency_3.evmos.claims.v1.Params.deserialize(reader));
                        break;
