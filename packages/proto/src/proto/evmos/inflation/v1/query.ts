...
export namespace evmos.inflation.v1 {
    ...
    export class QueryEpochMintProvisionResponse extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            epoch_mint_provision?: dependency_1.cosmos.base.v1beta1.DecCoin;
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
            if (!Array.isArray(data) && typeof data == "object") {
        ...
        get epoch_mint_provision() {
            return pb_1.Message.getWrapperField(this, dependency_1.cosmos.base.v1beta1.DecCoin, 1) as dependency_1.cosmos.base.v1beta1.DecCoin;
        }
        set epoch_mint_provision(value: dependency_1.cosmos.base.v1beta1.DecCoin) {
        ...
        static fromObject(data: {
            epoch_mint_provision?: ReturnType<typeof dependency_1.cosmos.base.v1beta1.DecCoin.prototype.toObject>;
        }): QueryEpochMintProvisionResponse {
            const message = new QueryEpochMintProvisionResponse({});
            if (data.epoch_mint_provision != null) {
                message.epoch_mint_provision = dependency_1.cosmos.base.v1beta1.DecCoin.fromObject(data.epoch_mint_provision);
            }
            return message;
        }
        toObject() {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): QueryEpochMintProvisionResponse {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.epoch_mint_provision, () => message.epoch_mint_provision = dependency_1.cosmos.base.v1beta1.DecCoin.deserialize(reader));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export class QueryCirculatingSupplyResponse extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            circulating_supply?: dependency_1.cosmos.base.v1beta1.DecCoin;
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
            if (!Array.isArray(data) && typeof data == "object") {
        ...
        set circulating_supply(value: dependency_1.cosmos.base.v1beta1.DecCoin) {
            pb_1.Message.setWrapperField(this, 1, value);
        }
        ...
        static fromObject(data: {
            circulating_supply?: ReturnType<typeof dependency_1.cosmos.base.v1beta1.DecCoin.prototype.toObject>;
        }): QueryCirculatingSupplyResponse {
            const message = new QueryCirculatingSupplyResponse({});
            if (data.circulating_supply != null) {
                message.circulating_supply = dependency_1.cosmos.base.v1beta1.DecCoin.fromObject(data.circulating_supply);
            }
            return message;
        }
        toObject() {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): QueryCirculatingSupplyResponse {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.circulating_supply, () => message.circulating_supply = dependency_1.cosmos.base.v1beta1.DecCoin.deserialize(reader));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export class QueryParamsResponse extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            params?: dependency_2.evmos.inflation.v1.Params;
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
            if (!Array.isArray(data) && typeof data == "object") {
        ...
        get params() {
            return pb_1.Message.getWrapperField(this, dependency_2.evmos.inflation.v1.Params, 1) as dependency_2.evmos.inflation.v1.Params;
        }
        set params(value: dependency_2.evmos.inflation.v1.Params) {
            pb_1.Message.setWrapperField(this, 1, value);
        }
        get has_params() {
            return pb_1.Message.getField(this, 1) != null;
        ...
        static fromObject(data: {
            params?: ReturnType<typeof dependency_2.evmos.inflation.v1.Params.prototype.toObject>;
        }): QueryParamsResponse {
            const message = new QueryParamsResponse({});
            if (data.params != null) {
                message.params = dependency_2.evmos.inflation.v1.Params.fromObject(data.params);
            }
            return message;
        }
        toObject() {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): QueryParamsResponse {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.params, () => message.params = dependency_2.evmos.inflation.v1.Params.deserialize(reader));
                        break;
                    default: reader.skipField();
                }
            }
