...
export namespace evmos.feesplit.v1 {
    export class GenesisState extends pb_1.Message {
        ...
        get fee_splits() {
            return pb_1.Message.getRepeatedWrapperField(this, dependency_1.evmos.feesplit.v1.FeeSplit, 2) as dependency_1.evmos.feesplit.v1.FeeSplit[];
        }
        ...
        toObject() {
            ...
            if (this.fee_splits != null) {
                data.fee_splits = this.fee_splits.map((item: dependency_1.evmos.feesplit.v1.FeeSplit) => item.toObject());
            }
            return data;
        }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.fee_splits !== undefined)
                writer.writeRepeatedMessage(2, this.fee_splits, (item: dependency_1.evmos.feesplit.v1.FeeSplit) => item.serialize(writer));
            if (!w)
    ...
    export class Params extends pb_1.Message {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            const writer = w || new pb_1.BinaryWriter();
            if (this.enable_fee_split !== undefined)
