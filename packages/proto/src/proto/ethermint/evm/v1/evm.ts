...
export namespace ethermint.evm.v1 {
    export class Params extends pb_1.Message {
        ...
        get extra_eips() {
            return pb_1.Message.getWrapperField(this, ExtraEIPs, 4) as ExtraEIPs;
        }
        set extra_eips(value: ExtraEIPs) {
        ...
        static fromObject(data: {
            ...
            enable_create?: boolean;
            enable_call?: boolean;
            extra_eips?: ReturnType<typeof ExtraEIPs.prototype.toObject>;
            ...
            if (data.extra_eips != null) {
                message.extra_eips = ExtraEIPs.fromObject(data.extra_eips);
            }
        ...
        toObject() {
            ...
            if (this.extra_eips != null) {
                data.extra_eips = this.extra_eips.toObject();
            }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.has_extra_eips)
                writer.writeMessage(4, this.extra_eips, () => this.extra_eips.serialize(writer));
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        reader.readMessage(message.extra_eips, () => message.extra_eips = ExtraEIPs.deserialize(reader));
                        break;
                    case 5:
    ...
    export class ExtraEIPs extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            eips?: number[];
        }) {
            ...
            if (!Array.isArray(data) && typeof data == "object") {
                if ("eips" in data && data.eips != undefined) {
                    this.eips = data.eips;
                }
            }
        }
        ...
        set eips(value: number[]) {
            pb_1.Message.setField(this, 1, value);
        }
        static fromObject(data: {
            eips?: number[];
        }): ExtraEIPs {
            const message = new ExtraEIPs({});
            if (data.eips != null) {
                message.eips = data.eips;
            }
            return message;
        }
        toObject() {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            const writer = w || new pb_1.BinaryWriter();
            if (this.eips.length)
                writer.writeRepeatedInt64(1, this.eips);
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): ExtraEIPs {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new ExtraEIPs();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
                    case 1:
                        pb_1.Message.addToRepeatedField(message, 1, reader.readInt64());
                        break;
                    default: reader.skipField();
                }
            }
        ...
        static deserializeBinary(bytes: Uint8Array): ExtraEIPs {
            return ExtraEIPs.deserialize(bytes);
        }
    }
