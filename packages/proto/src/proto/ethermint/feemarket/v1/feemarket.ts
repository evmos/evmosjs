    ...
    export class Params extends pb_1.Message {
        constructor(data?: any[] | {
            ...
            if (!Array.isArray(data) && typeof data == "object") {
                ...
                if ("initial_base_fee" in data && data.initial_base_fee != undefined) {
                    this.initial_base_fee = data.initial_base_fee;
                }
        ...
        get initial_base_fee() {
            return pb_1.Message.getField(this, 4) as number;
        }
        set initial_base_fee(value: number) {
        ...
        static fromObject(data: {
            ...
            if (data.initial_base_fee != null) {
                message.initial_base_fee = data.initial_base_fee;
            }
        ...
        toObject() {
            ...
            if (this.initial_base_fee != null) {
                data.initial_base_fee = this.initial_base_fee;
            }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.initial_base_fee !== undefined)
                writer.writeInt64(4, this.initial_base_fee);
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        message.initial_base_fee = reader.readInt64();
                        break;
                    case 5:
